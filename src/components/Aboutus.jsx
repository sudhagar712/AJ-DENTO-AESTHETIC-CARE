    ...
    return (
        <section id="about-us" className="relative w-full py-24 px-6 md:px-12 bg-white overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto flex flex-col items-center text-center relative z-10 space-y-12">
                ...
                {/* Emphasized Quote */}
                <div className="relative py-6 px-8 max-w-2xl">
                    <span className="absolute top-0 left-0 text-6xl text-[#D4AF37]/20 font-serif leading-none">“</span>
                    ...
                    <span className="absolute bottom-0 right-0 text-6xl text-[#D4AF37]/20 font-serif leading-none">”</span>
                </div>
